...
public class OptitrackStreamingClient : MonoBehaviour
{
    ...
    public event EventHandler<Dictionary<Int32, OptitrackRigidBodyState>> OnRigidBodyStatesUpdated;

    public Dictionary<Int32, OptitrackRigidBodyState> RigidBodyStates
    {
        get
        {
            return m_latestRigidBodyStates;
        }
    }
